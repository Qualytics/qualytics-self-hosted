# Qualytics Docker Images - v2026.9.4

This guide lists the images used by Qualytics chart `2026.9.4`. The chart pulls them directly by default; use the mirroring steps when your organization requires an internal registry.
...
|---|---|---|---|
| Control Plane (API & CMD) | `qualyticsai/controlplane` | `20260904-ca35e72` | `qualytics-api` and `qualytics-cmd` Deployments |
| Data Plane (Spark) | `qualyticsai/dataplane` | `20260904-a1ac9ab` | `qualytics-spark` driver Deployment and every executor pod the driver creates |
| Frontend | `qualyticsai/frontend` | `20260904-df4d84e` | `qualytics-frontend` Deployment |
...
docker pull qualyticsai/controlplane:20260904-ca35e72
docker pull qualyticsai/dataplane:20260904-a1ac9ab
docker pull qualyticsai/frontend:20260904-df4d84e
```
...
# Qualytics images
docker tag qualyticsai/controlplane:20260904-ca35e72 "$REGISTRY/qualyticsai/controlplane:20260904-ca35e72"
docker tag qualyticsai/dataplane:20260904-a1ac9ab "$REGISTRY/qualyticsai/dataplane:20260904-a1ac9ab"
docker tag qualyticsai/frontend:20260904-df4d84e "$REGISTRY/qualyticsai/frontend:20260904-df4d84e"
...
# Push all
docker push "$REGISTRY/qualyticsai/controlplane:20260904-ca35e72"
docker push "$REGISTRY/qualyticsai/dataplane:20260904-a1ac9ab"
docker push "$REGISTRY/qualyticsai/frontend:20260904-df4d84e"
